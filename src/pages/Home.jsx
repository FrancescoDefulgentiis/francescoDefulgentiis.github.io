        ...
        <div className="space-y-16">
            ...
            <section className="animate-in fade-in duration-1000 delay-300 border-t-2 border-black pt-8">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
                    ...
                    <div>
                        <p className="font-mono text-gray-600 mb-4"> Chat with me &lt;</p>
                        <div className="flex gap-6">
                            <a
                                href="https://www.linkedin.com/in/francescodefulgentiis/"
                                target="_blank"
                            ...
                            >
                                <svg
                                    className="w-8 h-8 fill-current text-black group-hover:text-accent-primary transition-colors"
                                    viewBox="0 0 24 24"
                                >
                            ...
                            <a
                                href="https://github.com/francescoDefulgentiis"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="group"
                                aria-label="GitHub"
                            >
                                <svg
                                    className="w-8 h-8 fill-current text-black group-hover:text-accent-tertiary transition-colors"
                                    viewBox="0 0 24 24"
                                >
                            ...
                            <a
                                href="https://www.instagram.com/francescodefulgentiis/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="group"
                            ...
                            >
                                <svg
                                    className="w-8 h-8 fill-current text-black group-hover:text-accent-secondary transition-colors"
                                    viewBox="0 0 24 24"
                                >
